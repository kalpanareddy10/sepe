...
public class ClipTest {
    ...
    public void testSetTitleToEmptyStringKeepsPreviousValue() {
        ...
        assertTrue(OriginalTitle.equals(OriginalTitle));// compare original title and resulted title
    ...
    public void testSetEndBeforeStartKeepsPreviousValue()
    {
       ...
       int OriginalStartTime = 07; // sub video start time
       int originalEndtime = 7;// sub video end time
